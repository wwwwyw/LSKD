...
def get_argparser():
    ...
    parser.add_argument("--aaaaaa", default=0.9, type=float)
    parser.add_argument("--ppp", default=1., type=float)
    parser.add_argument("--mmm", default=12, type=int)

    parser.add_argument("--dis", choices=["L1_mean", "mean_L1","L2","cos"], default=None)
    parser.add_argument("--sigmoid", choices=["old", "newnone","none","gt","whc"], default=None)
    parser.add_argument("--pooling_without_zero", action="store_true", default=False)
    parser.add_argument("--yess", default=1., type=float)
    parser.add_argument("--adaptivealpha", default=0.5, type=float)
    parser.add_argument("--adaptivebeta", default=0.5, type=float)
    parser.add_argument("--adaptivegamma", default=0.5, type=float)
